...
- This is a research project, so make sure to show all the works and ensure reproducibility. Don't just randomly define random constants, include the code used to generate/select these constants.
