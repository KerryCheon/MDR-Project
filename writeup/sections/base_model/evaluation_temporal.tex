...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{../results/figures/writeup/w_vs_no_w_model.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{../results/figures/writeup/res_vs_obs.png}
