...
\midrule
\textbf{Temporal alignment} & Aggregate irregular observations to daily resolution \\
\textbf{Spatial processing} & Extract features using station-centered spatial buffers \\
\textbf{Weather aggregation} & Convert hourly weather data to daily totals \\
\textbf{Imputation} & Fill missing values using ensemble methods \\
\textbf{Smoothing} & Reduce noise in time series signals \\
\textbf{Caching} & Store intermediate results for efficiency \\
\bottomrule
\end{tabular}
