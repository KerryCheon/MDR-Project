#!/usr/bin/env python3
"""Systematic-bias diagnostic for derived_8.4-eval-mlp-2.3 (offline, no GPU).
...
def print_report(bias_df: pd.DataFrame, cluster_df: pd.DataFrame) -> None:
    print("=" * 78)
    print("SYSTEMATIC-BIAS DIAGNOSTIC — derived_8.4-eval-mlp-2.3")
    print("=" * 78)
    ...
    print("2.2 success criterion: per-family median < 5%.\n")
