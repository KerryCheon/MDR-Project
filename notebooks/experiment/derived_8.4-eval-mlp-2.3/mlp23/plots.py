"""Plotting helpers for derived_8.4-eval-mlp-2.3.
...
FAMILY_LABELS = {
    ...
    "2regime_mixed": "2-regime Mixed (c0=96 pool, c1=54+10)",
}
...
def plot_sweep_summary(sweep_df: pd.DataFrame, out_dir: Path) -> Path:
    ...
    plt.suptitle("Neural Tabular Hyperparameter Sweep (30 configs, 3 two-regime families)", fontsize=13, weight="bold")
    plt.tight_layout()
