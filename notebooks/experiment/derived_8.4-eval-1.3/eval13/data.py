"""Data loading and candidate pool management for derived_8.4-eval-1.2 (LOSO).

Identical feature handling to derived_8.4-eval-1.1: loads the derived_8.4 split,
builds trainval = train + val, and exposes the shared 54-feature backbone, the
V0-50 baseline features, and the candidate pool.
"""
