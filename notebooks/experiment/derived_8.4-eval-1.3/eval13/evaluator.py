"""LOSO fold-aware model evaluation for derived_8.4-eval-1.3.
...
Compared with derived_8.4-eval-1.2, the NEW strategy Clustering_Backbone54_k2
routes on the 54 shared-backbone features (same as the single-regime global
model) instead of the V0-50 features; everything else is identical.
"""
