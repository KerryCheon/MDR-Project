...
def top_configs_per_family(out: Path, families: list[str], top_n: int) -> dict[str, list[str]]:
    import pandas as pd
    ...
    for fam in families:
        ...
        out_map[fam] = sub.head(top_n)["config_id"].tolist()
    return out_map
...
def main() -> None:
    ...
    fam_cids = top_configs_per_family(args.out, families, args.top_n)
