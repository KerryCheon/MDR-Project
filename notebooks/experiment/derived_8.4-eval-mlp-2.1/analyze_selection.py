#!/usr/bin/env python3
"""Selection-reliability diagnostic for derived_8.4-eval-mlp-2.1 (offline, no GPU).
...
test. 2.1's structural mitigations: no fg/plr in the pool (the main 2.0
...
def print_report(df: pd.DataFrame) -> None:
    print("=" * 78)
    print("SELECTION-RELIABILITY DIAGNOSTIC — derived_8.4-eval-mlp-2.1 (3-seed selection)")
    print("=" * 78)
