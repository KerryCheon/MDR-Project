#!/usr/bin/env python3
"""Selection-reliability diagnostic for derived_8.4-eval-mlp-2.2 (offline, no GPU).
...
def print_report(df: pd.DataFrame) -> None:
    print("=" * 78)
    print("SELECTION-RELIABILITY DIAGNOSTIC — derived_8.4-eval-mlp-2.2 (3-seed selection)")
    print("=" * 78)
