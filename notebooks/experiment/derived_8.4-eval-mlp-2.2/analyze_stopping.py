...
(curves_swa.npy: [swa_val, swa_aux, swa_test], written by the mlp22 trainer
...
Usage:
  python analyze_stopping.py [--exp-dir <dir>] [--out <dir>] [--tag 21]
"""
...
def main() -> None:
    ...
    parser.add_argument("--tag", default="21")
