...
# Import T_2REGIME from dataset_metadata
sys.path.append(str(project_root / "data" / "splits" / "derived_8.1"))
from dataset_metadata import T_2REGIME
...
def main():
    config_path = "notebooks/experiment/derived_8.1-feature-selection/config.yaml"
    ...
    print("="*60)
    print(f"""# 2-Regime threshold and features calibrated using calibrate_valleys.py on derived_8.1 Train
# Valley is at 0.159 (rounded to 0.16) which separates dry modes from wet/transition modes.
T_2REGIME = {T_2REGIME}
