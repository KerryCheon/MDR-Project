"""Data loading for derived_8.4-formal-eval-1.0.

Adapted from derived_8.4-eval-1.3/eval13/data.py (identical feature handling):
loads the derived_8.4 split, builds trainval = train + val, and exposes the shared
54-feature backbone, the V0-50 baseline features, and the candidate pool.
"""
