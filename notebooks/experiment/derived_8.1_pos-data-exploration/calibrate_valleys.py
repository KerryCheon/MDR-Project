...
def main():
    ...
    parser.add_argument("--split-dir", type=str, default=None, 
                        help="Path to the split directory containing train.csv. Defaults to data/splits/derived_8.1_pos/")
    ...
    if args.plot:
        ...
        plt.title("Programmatic Valley-Based Threshold Calibration (derived_8.1_pos Train)", pad=15)
