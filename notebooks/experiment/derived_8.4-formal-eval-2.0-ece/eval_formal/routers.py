"""Routing / Gating strategy implementations for derived_8.4-formal-eval-1.0.

Identical to derived_8.4-eval-1.3/eval13/routers.py (6 routers). The router seed is
fixed at the config's router_seed (42) by the evaluator — see config.yaml for why the
seed scope excludes routing (delta additions are tied to the seed-42 cluster labels).
"""
