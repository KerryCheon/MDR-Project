#!/usr/bin/env python3
"""Spatial (In-Situ ECE) evaluation driver for derived_8.4-formal-eval-2.0-ece (30 seeds).

Evaluates the 20 pinned configurations x 30 seeds on derived_8.4-ece (5 in-situ stations:
...
def main() -> None:
    ...
    print("=" * 70, flush=True)
    print("Spatial (In-Situ ECE) evaluation — derived_8.4-formal-eval-2.0-ece", flush=True)
    print("=" * 70, flush=True)
