#!/usr/bin/env python3
"""Temporal evaluation driver for derived_8.4-formal-eval-2.0-ece (frozen split, 30 seeds).
...
def main() -> None:
    ...
    print("=" * 70, flush=True)
    print("Temporal evaluation (frozen split, multi-seed) — derived_8.4-formal-eval-2.0-ece", flush=True)
    print("=" * 70, flush=True)
