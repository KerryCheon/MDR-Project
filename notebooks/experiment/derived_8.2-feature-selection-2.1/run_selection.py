#!/usr/bin/env python3
"""Run versioned feature-selection variants for derived_8.2-feature-selection-2.1.
...
Artifacts land under:
  notebooks/experiment/derived_8.2-feature-selection-2.1/artifacts/<dataset>/<variant>/
"""
