#!/usr/bin/env python3
"""Overfitting-symptom analysis for derived_8.4-eval-mlp-1.2 (no retraining).
...
The report notebook (derived_8.4-eval-mlp-1.2.ipynb) imports compute_overfitting
...
def print_report(r: dict) -> None:
    ...
    print("=" * 78)
    print("OVERFITTING-SYMPTOM ANALYSIS — derived_8.4-eval-mlp-1.2 (from sweep artifacts)")
    print("=" * 78)
