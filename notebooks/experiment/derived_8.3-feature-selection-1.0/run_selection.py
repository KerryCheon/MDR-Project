#!/usr/bin/env python3
"""Run versioned feature-selection variants for derived_8.3-feature-selection-1.0.

Usage (from repo root):
  PYTHONPATH=. python notebooks/experiment/derived_8.3-feature-selection-1.0/run_selection.py \
      --dataset derived_8.3 --variants c2_xgb c0_baseline_bypass_on

Artifacts land under:
  notebooks/experiment/derived_8.3-feature-selection-1.0/artifacts/<dataset>/<variant>/
"""
...
def main(argv=None):
    ...
    datasets = args.dataset or ["derived_8.3"]
    results = []
    for ds in datasets:
