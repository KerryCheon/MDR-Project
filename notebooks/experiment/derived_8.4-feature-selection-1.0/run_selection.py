#!/usr/bin/env python3
"""Run versioned feature-selection variants for derived_8.4-feature-selection-1.0.

Usage (from repo root):
  PYTHONPATH=. python notebooks/experiment/derived_8.4-feature-selection-1.0/run_selection.py \
      --dataset derived_8.4 --variants c2_xgb c0_baseline_bypass_on

Artifacts land under:
  notebooks/experiment/derived_8.4-feature-selection-1.0/artifacts/<dataset>/<variant>/
"""
...
DATASETS = {
    ...
    "derived_8.3": {
        "train": "data/splits/derived_8.3/train.csv",
        "val": "data/splits/derived_8.3/val.csv",
        "test": "data/splits/derived_8.3/test.csv",
    },
    "derived_8.2": {
...
def main(argv=None):
    ...
    parser.add_argument(
        ...
        help="Dataset(s) to run (repeatable). Default: derived_8.3.",
    )
    parser.add_argument(
        "--variants",
        nargs="+",
    ...
    datasets = args.dataset or ["derived_8.4"]
    results = []
    for ds in datasets:
