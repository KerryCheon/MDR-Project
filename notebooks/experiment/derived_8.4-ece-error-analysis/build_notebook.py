...
"""))
    ...
    cells.append(make_cell("markdown", r"""## 5. Spatial Scale Mismatch & Empirical Side-by-Side Comparisons
...
display(t4)
print("\n=== TABLE 4B: EMPIRICAL SIDE-BY-SIDE FEATURE COMPARISONS (53m & 364m PAIRS) ===")
display(t4b)
...
"""))
    ...
    # Cell 7: Section 6 - Target Distribution & Domain Shift
    cells.append(make_cell("markdown", r"""## 7. Target Distribution & Climatological Domain Shift
...
"""))
    ...
    # Cell 8: Section 7 - Routing Strategies & MoE Traps
    cells.append(make_cell("markdown", r"""## 8. Routing Strategy Comparison & MoE Failure Modes
...
"""))
    ...
    # Cell 9: Section 8 - Sensor Hardware & Calibration
    cells.append(make_cell("markdown", r"""## 9. Sensor Hardware, Calibration & Negative Value Clarification
...
"""))
    ...
    # Cell 10: Section 9 - Error Decomposition Waterfall
    cells.append(make_cell("markdown", r"""## 10. Error Decomposition Synthesis
...
"""))
    ...
    # Cell 11: Section 10 - Actionable Recommendations
    cells.append(make_cell("markdown", r"""## 11. Actionable Recommendations & Future Roadmap
