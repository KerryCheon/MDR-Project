"""Run the complete feature-selection 2.0 experiment with safe resume."""
...
STAGES = (
    _stage("selection", "run_selection.py", ["final/derived_8.0/global/completion.json", "final/derived_8.3/global/completion.json", "final/derived_8.3/router_provenance.json", "final/derived_8.3/regime_0/completion.json", "final/derived_8.3/regime_1/completion.json"]),
    ...
    _stage("nested_selection", "run_nested_selection.py", ["nested/derived_8.0/global/completion.json", "nested/derived_8.3/global/completion.json", "nested/derived_8.3/router.json", "nested/derived_8.3/regime_0/completion.json", "nested/derived_8.3/regime_1/completion.json"]),
    _stage("nested_locked_outer", "run_locked_outer_selection.py", ["nested_locked_outer/derived_8.0/global/completion.json", "nested_locked_outer/derived_8.3/global/completion.json"]),
    _stage("crossed_selection", "run_crossed_candidate_selection.py", ["crossed_candidates_locked_outer/derived_8.0/global/completion.json", "crossed_candidates_locked_outer/derived_8.3/global/completion.json"]),
...
def _fingerprint(stage: dict) -> dict:
    paths = sorted(EXP_DIR.glob("*.py")) + sorted(EXP_DIR.glob("*.yaml"))
