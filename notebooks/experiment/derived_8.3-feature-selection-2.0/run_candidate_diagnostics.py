...
results are explicitly retrospective because derived_8.3-eval-1.0 already
consumed that test split; they must not support a new unbiased SOTA claim.
"""
...
def main(argv=None) -> None:
    ...
    manifest = {
        ...
        "reason": "derived_8.3-eval-1.0 already consumed the test split.",
    }
