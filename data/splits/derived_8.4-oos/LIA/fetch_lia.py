# fetch_lia.py
# Fetches station-level Sentinel-1 Local Incidence Angle (LIA) summary
...
def main():
    ...
    ap.add_argument("--stations-csv", default="data/splits/derived_8.4-oos/LIA/stations.csv")
    ap.add_argument("--out-csv", default="data/splits/derived_8.4-oos/LIA/stations_lia.csv")
