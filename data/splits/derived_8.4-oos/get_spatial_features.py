...
def main():
    ...
    ap.add_argument("--coords_csv", default="data/splits/derived_8.4-oos/station_coords.csv")
    ap.add_argument("--out_csv", default="data/splits/derived_8.4-oos/station_static_features.csv")
