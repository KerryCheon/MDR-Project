...
def main():
    ...
    ap.add_argument("--stations-csv", default="data/splits/derived_8.4-ece/LIA/stations.csv")
    ap.add_argument("--out-csv", default="data/splits/derived_8.4-ece/LIA/stations_lia.csv")
